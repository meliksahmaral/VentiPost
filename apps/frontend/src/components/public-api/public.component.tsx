    ...
    <div className="flex flex-col">
      ...
      <div className="text-customColor18 mt-[4px]">
        {t(
          ...
          'Use VentiPost API to integrate with your tools.'
        )}
        <br />
        <a
        ...
        >
          <br />
          {t('check_n8n', 'Check out our N8N custom node for VentiPost.')}
        </a>
      </div>
      ...
      <div className="text-customColor18 mt-[4px]">
        {t(
          ...
          'Connect VentiPost MCP server to your client (Http streaming) to schedule your posts faster.'
        )}
      </div>
      <div className="my-[16px] mt-[16px] bg-sixth border-fifth items-center border rounded-[4px] p-[24px] flex gap-[24px]">
        <div className="flex items-center">
